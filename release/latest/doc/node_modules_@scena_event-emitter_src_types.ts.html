...
<head>
    <meta charset="utf-8">
    <title>node_modules/@scena/event-emitter/src/types.ts - Documentation</title>
    ...
    <meta name="description" content="node_modules/@scena/event-emitter/src/types.ts - Documentation"/>
...
<div id="main">
    ...
    <h1 class="page-title">node_modules/@scena/event-emitter/src/types.ts</h1>
...
nav li[file="node_modules/@scena/event-emitter/src/types"]:after {
    display: none;
}
nav li[file="node_modules/@scena/event-emitter/src/types"] h4, nav li[file="node_modules/@scena/event-emitter/src/types"] ul {
    display: block;
}
</style>
